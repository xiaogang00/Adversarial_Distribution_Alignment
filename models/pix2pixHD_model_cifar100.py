...
from .cls.wideresnet import WideResNet
from .cls.resnet import ResNet50_class100
...
class Pix2PixHDModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        resume_path = 'model_cls_NoD/cifar100/wideresnet/model.pt'
        self.cls_model = ResNet50_class100().cuda()
    ...
    def encode_input3(self, image, label, infer=False):
        ...
        real_image = F.interpolate(real_image, size=(32, 32), mode='bilinear', align_corners=True)
        ...
        real_image_clone = F.interpolate(real_image_clone, size=(32, 32), mode='bilinear', align_corners=True)
