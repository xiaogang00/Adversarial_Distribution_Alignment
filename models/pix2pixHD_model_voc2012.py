...
class Pix2PixHDModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        resume_path = 'model_seg_NoD/voc2012/pspnet/train_epoch_50.pth'
        seg_model = pspnet.DeepLabV3(layers=50, classes=21, zoom_factor=8, criterion=self.seg_criterion, BatchNorm=BatchNorm)
