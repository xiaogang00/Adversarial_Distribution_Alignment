...
def main():
    ...
    model_black = ResNet50().to(device)
    model_path_this = '../model_cls_NoD/cifar10/resnet50/model.pt'
    model_black.load_state_dict(torch.load(model_path_this))
    ...
    save_path = '../checkpoints/cifar10_model_wideresnet/last_net_G.pth'
    save_path_list = [save_path]

    model = WideResNet().to(device)
    model_path_this = '../model_cls_NoD/cifar10/wideresnet/model.pt'
    model.load_state_dict(torch.load(model_path_this))
