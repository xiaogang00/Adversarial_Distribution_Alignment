...
def main():
    ...
    model_black = WideResNet2(num_classes=200).to(device)
    model_path = '../model_cls_NoD/tinyimagenet/resnet50/model.pt'
    model_black.load_state_dict(torch.load(model_path))

    model = ResNet50_class200().to(device)
    model_path = '../model_cls_NoD/tinyimagenet/wideresnet/model.pt'
    model.load_state_dict(torch.load(model_path))

    save_path = '../checkpoints/tinyimagenet_model_wideresnet/last_net_G.pth'
